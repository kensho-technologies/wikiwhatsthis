...
setup(
    ...
    description="Package for building WikiWhatsThis models.",
    long_description=find_long_description(),
    long_description_content_type="text/markdown",
    url="https://github.com/kensho-technologies/wikiwhatsthis",
    ...
    keywords="wikipedia wikidata wikimedia open data",
    python_requires=">=3.6",
)
